/*
 * Model-specific defintions for "stateflow_FMU_test"
 *
...
#include "simstruc.h"
#define MODEL_GUID                     "{3dfa8b4f-4ce2-4036-ac9c-93fc75ade99d}"
...
/* Model identifier */
#define SFCN_FMI_MODEL_IDENTIFIER      "stateflow_FMU_test"
