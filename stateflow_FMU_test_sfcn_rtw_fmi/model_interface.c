...
void initializeModelVariables(SimStruct* S, ModelVariable modelVariables[])
{
  ...
  modelVariables[12].address = &(((B_stateflow_FMU_test_T *) ssGetLocalBlockIO(S))
    ->waitState);
  modelVariables[13].dtypeID = 0;
  modelVariables[13].size = 0;
  modelVariables[13].address = &(((B_stateflow_FMU_test_T *) ssGetLocalBlockIO(S))
    ->onState);
  modelVariables[14].dtypeID = 0;
  modelVariables[14].size = 0;
  modelVariables[14].address = &(((B_stateflow_FMU_test_T *) ssGetLocalBlockIO(S))
    ->offState);
  modelVariables[15].dtypeID = 0;
  modelVariables[15].size = 0;
  modelVariables[15].address = &(((B_stateflow_FMU_test_T *) ssGetLocalBlockIO(S))
    ->delayState);
  modelVariables[16].dtypeID = 0;
  modelVariables[16].size = 0;
  modelVariables[16].address = &(((B_stateflow_FMU_test_T *) ssGetLocalBlockIO(S))
    ->queueState);
  modelVariables[17].dtypeID = 0;
  modelVariables[17].size = 0;
  modelVariables[17].address = &(((B_stateflow_FMU_test_T *) ssGetLocalBlockIO(S))
    ->startState);
}
