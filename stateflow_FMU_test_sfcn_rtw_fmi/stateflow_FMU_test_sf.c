...
#include "stateflow_FMU_test_sf_private.h"
#include "simstruc.h"
...
extern void *stateflow_FMU_test_malloc(SimStruct *S);
...
static void mdlInitializeConditions(SimStruct *S)
{
  if (ssIsFirstInitCond(S)) {
    B_stateflow_FMU_test_T *_rtB;
    _rtB = ((B_stateflow_FMU_test_T *) ssGetLocalBlockIO(S));
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  if (((uint8_T *)ssGetDWork(S, 0))[0] == 0U) {
    ...
    /* Transition: '<S1>:2' */
    ((uint8_T *)ssGetDWork(S, 1))[0] = stateflow_FMU_test_IN_start;
    ...
    switch (((uint8_T *)ssGetDWork(S, 1))[0]) {
     case stateflow_FMU_test_IN_delay:
      ...
      if (*((const real_T **)ssGetInputPortSignalPtrs(S, 0))[0] == 0.0) {
        /* Transition: '<S1>:16' */
        ((uint8_T *)ssGetDWork(S, 1))[0] = stateflow_FMU_test_IN_wait;

        /* Entry 'wait': '<S1>:5' */
        _rtB->waitState = 1.0;
      } else if (*((const real_T **)ssGetInputPortSignalPtrs(S, 3))[0] == 1.0) {
        /* Transition: '<S1>:18' */
        ((uint8_T *)ssGetDWork(S, 1))[0] = stateflow_FMU_test_IN_queue;
     ...
     case stateflow_FMU_test_IN_off:
      ...
      if ((*((const real_T **)ssGetInputPortSignalPtrs(S, 5))[0] == 0.0) && (*((
        ...
        /* Transition: '<S1>:22' */
        ((uint8_T *)ssGetDWork(S, 1))[0] = stateflow_FMU_test_IN_on;
     ...
     case stateflow_FMU_test_IN_on:
      ...
      if ((*((const real_T **)ssGetInputPortSignalPtrs(S, 4))[0] == 1.0) && (*((
        ...
        /* Transition: '<S1>:21' */
        ((uint8_T *)ssGetDWork(S, 1))[0] = stateflow_FMU_test_IN_off;
     ...
     case stateflow_FMU_test_IN_queue:
      ...
      if (*((const real_T **)ssGetInputPortSignalPtrs(S, 3))[0] == 1.0) {
        /* Transition: '<S1>:19' */
        ((uint8_T *)ssGetDWork(S, 1))[0] = stateflow_FMU_test_IN_delay;
...
#if defined(RT_MALLOC) || defined(MATLAB_MEX_FILE)
#include "stateflow_FMU_test_mid.h"
#endif
...
#define S_FUNCTION_NAME                stateflow_FMU_test_sf
#include "cg_sfun.h"
