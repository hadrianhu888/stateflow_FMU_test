  % Autogenerated file: Wed Jun  1 19:12:20 2022
...
codeInfo = codeIRInfoStruct.codeInfo;
  ...
  wr = coder.internal.writeDataInterfacesToCodeDescriptor("stateflow_FMU_test_mod_stdfmi",pwd) ;
  ...
  skippedParameters = [];
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        func_Initialize_Prototype.HeaderFile = ['stateflow_FMU_test_mod_stdfmi', '.h'];
    func_Initialize_Prototype.SourceFile = ['stateflow_FMU_test_mod_stdfmi', '.c'];
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'stateflow_FMU_test_mod_stdfmi_initialize';
    ...
    func_OutputUpdate_Prototype.Return     = tmpRet;
        func_OutputUpdate_Prototype.HeaderFile = ['stateflow_FMU_test_mod_stdfmi', '.h'];
    func_OutputUpdate_Prototype.SourceFile = ['stateflow_FMU_test_mod_stdfmi', '.c'];
    ...
    func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate_Prototype.Name = 'stateflow_FMU_test_mod_stdfmi_step';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        func_Terminate_Prototype.HeaderFile = ['stateflow_FMU_test_mod_stdfmi', '.h'];
    func_Terminate_Prototype.SourceFile = ['stateflow_FMU_test_mod_stdfmi', '.c'];
    ...
    time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_constant;
                func_Terminate_Prototype.Name = ['stateflow_FMU_test_mod_stdfmi_terminate'];
