  % Autogenerated file: Thu Jun  2 19:13:36 2022
...
codeInfo = codeIRInfoStruct.codeInfo;
  ...
  wr = coder.internal.writeDataInterfacesToCodeDescriptor("maxCalculatorTest_grtfmi_v0",pwd) ;
  ...
  skippedParameters = [];
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        func_Initialize_Prototype.HeaderFile = ['maxCalculatorTest_grtfmi_v0', '.h'];
    func_Initialize_Prototype.SourceFile = ['maxCalculatorTest_grtfmi_v0', '.c'];
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'maxCalculatorTest_grtfmi_v0_initialize';
    ...
    func_OutputUpdate_Prototype.Return     = tmpRet;
        func_OutputUpdate_Prototype.HeaderFile = ['maxCalculatorTest_grtfmi_v0', '.h'];
    func_OutputUpdate_Prototype.SourceFile = ['maxCalculatorTest_grtfmi_v0', '.c'];
    ...
    func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate_Prototype.Name = 'maxCalculatorTest_grtfmi_v0_step';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        func_Terminate_Prototype.HeaderFile = ['maxCalculatorTest_grtfmi_v0', '.h'];
    func_Terminate_Prototype.SourceFile = ['maxCalculatorTest_grtfmi_v0', '.c'];
    ...
    time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_constant;
                func_Terminate_Prototype.Name = ['maxCalculatorTest_grtfmi_v0_terminate'];
