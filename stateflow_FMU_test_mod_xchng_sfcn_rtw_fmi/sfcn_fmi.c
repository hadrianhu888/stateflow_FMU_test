 ...
 *  from Simulink model "stateflow_FMU_test_mod_xchng".
 *
...
#define RTW_GENERATED_SFCN_TUNABLE_PRMS_stateflow_FMU_test_mod_xchng_sf
...
#include "stateflow_FMU_test_mod_xchng_sf.c"
