/*
 * stateflow_FMU_test_mod_xchng_mid.h
 *
...
/* Instance data for model: stateflow_FMU_test_mod_xchng */
void *stateflow_FMU_test_mod_xchng_malloc(SimStruct *rts)
{
  ...
  /* block I/O */
  {
    void *b = malloc(sizeof(B_stateflow_FMU_test_mod_xchng_T));
