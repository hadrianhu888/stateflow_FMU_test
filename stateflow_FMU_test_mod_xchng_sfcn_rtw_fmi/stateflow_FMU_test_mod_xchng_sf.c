/*
 * stateflow_FMU_test_mod_xchng_sf.c
 *
...
#include "stateflow_FMU_test_mod_xchng_sf_private.h"
#include "simstruc.h"
...
#define stateflow_FMU_test_mod_x_IN_off ((uint8_T)2U)
#define stateflow_FMU_test_mod_xc_IN_on ((uint8_T)3U)
#define stateflow_FM_IN_NO_ACTIVE_CHILD ((uint8_T)0U)
#if defined(RT_MALLOC) || defined(MATLAB_MEX_FILE)

extern void *stateflow_FMU_test_mod_xchng_malloc(SimStruct *S);
...
static void mdlInitializeConditions(SimStruct *S)
{
  if (ssIsFirstInitCond(S)) {
    B_stateflow_FMU_test_mod_xchng_T *_rtB;
    _rtB = ((B_stateflow_FMU_test_mod_xchng_T *) ssGetLocalBlockIO(S));
...
static void mdlStart(SimStruct *S)
{
  ...
  stateflow_FMU_test_mod_xchng_malloc(S);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  if (((uint8_T *)ssGetDWork(S, 0))[0] == 0U) {
    ...
    /* Transition: '<S1>:2' */
    ((uint8_T *)ssGetDWork(S, 1))[0] = stateflow_FMU_test_mod_IN_start;
    ...
    switch (((uint8_T *)ssGetDWork(S, 1))[0]) {
     case stateflow_FMU_test_mod_IN_delay:
      ...
      if (*((const real_T **)ssGetInputPortSignalPtrs(S, 0))[0] == 0.0) {
        /* Transition: '<S1>:16' */
        ((uint8_T *)ssGetDWork(S, 1))[0] = stateflow_FMU_test_mod__IN_wait;

        /* Entry 'wait': '<S1>:5' */
        _rtB->waitState = 1.0;
      } else if (*((const real_T **)ssGetInputPortSignalPtrs(S, 3))[0] == 1.0) {
        /* Transition: '<S1>:18' */
        ((uint8_T *)ssGetDWork(S, 1))[0] = stateflow_FMU_test_mod_IN_queue;

        /* Entry 'queue': '<S1>:7' */
      }
      break;

     case stateflow_FMU_test_mod_x_IN_off:
      /* During 'off': '<S1>:4' */
      if ((*((const real_T **)ssGetInputPortSignalPtrs(S, 5))[0] == 0.0) && (*((
        ...
        /* Transition: '<S1>:22' */
        ((uint8_T *)ssGetDWork(S, 1))[0] = stateflow_FMU_test_mod_xc_IN_on;
     ...
     case stateflow_FMU_test_mod_xc_IN_on:
      /* During 'on': '<S1>:3' */
      if ((*((const real_T **)ssGetInputPortSignalPtrs(S, 4))[0] == 1.0) && (*((
        ...
        /* Transition: '<S1>:21' */
        ((uint8_T *)ssGetDWork(S, 1))[0] = stateflow_FMU_test_mod_x_IN_off;
     ...
     case stateflow_FMU_test_mod_IN_queue:
      ...
      if (*((const real_T **)ssGetInputPortSignalPtrs(S, 3))[0] == 1.0) {
        /* Transition: '<S1>:19' */
        ((uint8_T *)ssGetDWork(S, 1))[0] = stateflow_FMU_test_mod_IN_delay;
...
#if defined(RT_MALLOC) || defined(MATLAB_MEX_FILE)
#include "stateflow_FMU_test_mod_xchng_mid.h"
#endif
...
#define S_FUNCTION_NAME                stateflow_FMU_test_mod_xchng_sf
#include "cg_sfun.h"
