  % Autogenerated file: Wed Jun  1 18:47:09 2022
...
codeInfo = codeIRInfoStruct.codeInfo;
  ...
  wr = coder.internal.writeDataInterfacesToCodeDescriptor("stateflow_FMU_test",pwd) ;
  ...
  skippedParameters = [];
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        func_Initialize_Prototype.HeaderFile = ['stateflow_FMU_test', '.h'];
    func_Initialize_Prototype.SourceFile = ['stateflow_FMU_test', '.c'];
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'stateflow_FMU_test_initialize';
    ...
    func_OutputUpdate_Prototype.Return     = tmpRet;
        func_OutputUpdate_Prototype.HeaderFile = ['stateflow_FMU_test', '.h'];
    func_OutputUpdate_Prototype.SourceFile = ['stateflow_FMU_test', '.c'];
    ...
    func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate_Prototype.Name = 'stateflow_FMU_test_step';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        func_Terminate_Prototype.HeaderFile = ['stateflow_FMU_test', '.h'];
    func_Terminate_Prototype.SourceFile = ['stateflow_FMU_test', '.c'];
    ...
    time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_constant;
                func_Terminate_Prototype.Name = ['stateflow_FMU_test_terminate'];
