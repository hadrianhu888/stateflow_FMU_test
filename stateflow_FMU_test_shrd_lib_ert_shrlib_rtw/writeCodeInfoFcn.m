  % Autogenerated file: Wed Jun  1 19:19:05 2022
...
codeInfo = codeIRInfoStruct.codeInfo;
  ...
  wr = coder.internal.writeDataInterfacesToCodeDescriptor("stateflow_FMU_test_shrd_lib",pwd) ;
  ...
  skippedParameters = [];
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        func_Initialize_Prototype.HeaderFile = ['stateflow_FMU_test_shrd_lib', '.h'];
    func_Initialize_Prototype.SourceFile = ['stateflow_FMU_test_shrd_lib', '.c'];
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'stateflow_FMU_test_shrd_lib_initialize';
    ...
    func_OutputUpdate_Prototype.Return     = tmpRet;
        func_OutputUpdate_Prototype.HeaderFile = ['stateflow_FMU_test_shrd_lib', '.h'];
    func_OutputUpdate_Prototype.SourceFile = ['stateflow_FMU_test_shrd_lib', '.c'];
    ...
    func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate_Prototype.Name = 'stateflow_FMU_test_shrd_lib_step';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        func_Terminate_Prototype.HeaderFile = ['stateflow_FMU_test_shrd_lib', '.h'];
    func_Terminate_Prototype.SourceFile = ['stateflow_FMU_test_shrd_lib', '.c'];
    ...
    time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_constant;
                func_Terminate_Prototype.Name = ['stateflow_FMU_test_shrd_lib_terminate'];
